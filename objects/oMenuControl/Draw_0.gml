...
for (var i = 0; i < _number; i ++) {
	...
	shadowed_text(_text, room_width / 2, menu_start_position + i * menu_separation, menu_font, fa_center, fa_middle, menu_shadow_offset, _color, menu_shadow_color, 1, menu_shadow_alpha);	
}
